...
const Auth = () => {
  ...
  const handleMicrosoftLogin = () => {
    toast.info(
      'Microsoft SSO requires admin configuration. Please contact your administrator to set up Microsoft Azure AD integration.',
      { duration: 5000 }
    );
  };
  ...
  const handleSAMLLogin = () => {
    toast.info(
      'SAML SSO requires enterprise configuration. Please contact your administrator to configure SAML identity provider.',
      { duration: 5000 }
    );
  };
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-primary">
            {isLogin ? 'Welcome Back' : 'Join EvalifyAI'}
          </CardTitle>
          <CardDescription>
